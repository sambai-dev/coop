...
- Upgrade JWT verification to patched `jsonwebtoken` 10.4 with an explicit AWS-LC backend, checked-in Windows NASM objects, and regress malformed registered-claim types that previously enabled type-confusion bypasses.
